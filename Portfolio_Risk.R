...
analysis_data <- na.omit(merge(portf_ret, market_returns))
...
# rolling volatility
rolling_volatility <- runSD(portfolio_returns, n = 20) * sqrt(252)
...
chart.CumReturns(portfolio_returns, main = "Cumulative Return")
